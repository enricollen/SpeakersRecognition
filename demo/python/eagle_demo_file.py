    ...
    if command == 'enroll':
        ...
        try:
            eagle_profiler = pveagle.create_profiler(
                ...
                model_path=None,  # You may specify model_path or let the library use the default.
                library_path=None  # You may specify library_path or let the library use the default.
            )
